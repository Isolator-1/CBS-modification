...
class ScanAndReimageCompromisedMachines(DefenderAgent):
    ...
    def __init__(self, probability: float = 0.2, scan_capacity: int = 3, scan_frequency: int = 3):
...
class ExternalRandomEvents(DefenderAgent):
    ...
    def patch_vulnerabilities_at_random(self, environment: Environment) -> None:
    ...
    def stop_service_at_random(self, environment: Environment, actions: DefenderAgentActions) -> None:
        for node_id, node_data in environment.nodes():
    ...
    def plant_vulnerabilities_at_random(self, environment: Environment) -> None:
        for node_id, node_data in environment.nodes():
    ...
    def firewall_change_remove(self, environment: Environment) -> None:
        # Iterate through every node.
        for node_id, node_data in environment.nodes():
    ...
    def firewall_change_add(self, environment: Environment) -> None:
        # Iterate through every node.
        for node_id, node_data in environment.nodes():
